    ...
    data class Message(
        ...
        data class ReplyToMessage(
            ...
            data class Animation(
                    ...
                    val duration: Int, // 2
                    @Json(name = "file_id")
                    val fileId: String, // CgACAgQAAxkBAAMPXsKvNUDGv09mV-96cA0Tc0r5YF0AAicCAALC-QRS18h1tYcTY8cZBA
                    @Json(name = "file_name")
                ...
                data class Thumb(
                        @Json(name = "file_id")
                        val fileId: String, // AAMCBAADGQEAAw9ewq81QMa_T2ZX73pwDRNzSvlgXQACJwIAAsL5BFLXyHW1hxNjx_A0PBsABAEAB20AA28bAAIZBA
                        @Json(name = "file_size")
